...
// Lets shell.js force a specific rail category open (used by the first-run flow to land on
// "paths" regardless of whatever category localStorage last remembered -- see shell.js's own
// first-run branch for why that mismatch was a real bug: the Welcome banner used to say "fill in
// the paths below" while the rail could be showing any other category entirely).
