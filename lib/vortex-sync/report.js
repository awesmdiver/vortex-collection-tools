...
<body>
  ...
  ${hasIgnoredRows ? `<div class="callout callout--info">
    <p>Since the mods you marked as Ignored were never installed, we can't tell which plugin files belonged to them.
    But don't worry! Vortex will just treat any leftover plugin entries as missing files, same as any other uninstalled mod.</p>
  </div>` : ''}
