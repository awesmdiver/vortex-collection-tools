...
// spawnSync(), unlike the two sync functions above. Those are only ever called from the interactive
// CLI menu, where blocking the single-purpose terminal process for as long as the dialog is open is
// a non-issue. This one is called from an Express route handler in a long-running web server -- a
