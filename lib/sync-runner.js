...
const CRASH_HELP_TEXT =
    ...
    '1. Possible crash and a Windows error dialog might have appeared -- check your taskbar (it can open behind other windows) and click Abort.\n' +
    '2. If aborting that error (or there was no error at all) does not work, then open Vortex and click Refresh in the upper right corner of the Added Collections page. Then close Vortex.\n' +
